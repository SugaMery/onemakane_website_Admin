...
@Component({
  selector: 'app-list-users-not-actived',
  templateUrl: './list-users-not-actived.component.html',
  styleUrl: './list-users-not-actived.component.css'
})
export class ListUsersNotActivedComponent {
  users: any[] = [];
  pagedCategories: any[] = [];
  searchTerm: string = '';
