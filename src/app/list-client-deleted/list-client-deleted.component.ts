...
@Component({
  selector: 'app-list-client-deleted',
  templateUrl: './list-client-deleted.component.html',
  styleUrl: './list-client-deleted.component.css'
})
export class ListClientDeletedComponent {
  users: any[] = [];
  pagedCategories: any[] = [];
  searchTerm: string = '';
