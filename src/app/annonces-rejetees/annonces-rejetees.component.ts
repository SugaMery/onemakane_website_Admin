...
@Component({
  selector: 'app-annonces-rejetees',
  templateUrl: './annonces-rejetees.component.html',
  styleUrl: './annonces-rejetees.component.css'
})
export class AnnoncesRejeteesComponent {
  userData: any = {};
  adsCount: number = 0;
  ads: any[] = [];
  filteredAds: any[] = [];
  ...
  getAds(): void {
    this.annonceService.getAllAdsValidator("rejected").subscribe(
      data => {
        this.ads = data;
