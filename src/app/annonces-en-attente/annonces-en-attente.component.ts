...
@Component({
  selector: 'app-annonces-en-attente',
  templateUrl: './annonces-en-attente.component.html',
  styleUrl: './annonces-en-attente.component.css'
})
export class AnnoncesEnAttenteComponent {
  userData: any = {};
  adsCount: number = 0;
  ads: any[] = [];
  filteredAds: any[] = [];
  ...
  getAds(): void {
    this.annonceService.getAllAdsValidator("pending").subscribe(
      data => {
        this.ads = data;
